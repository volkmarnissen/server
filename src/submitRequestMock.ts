...
export function submitGetHoldingRegisterRequest(_slaveid: IslaveId, addresses: Set<ImodbusAddress>, resultFunction: (results: ImodbusValues) => void, _failedFunction: (e: any) => void): void {
    ...
    if (_slaveid.slaveid > 10) {
        ...
        addresses.forEach(addr => {
            ...
            switch (a) {
                ...
                default: m.set(addr.address, getReadRegisterResult(0));
            }
            else
            switch (a) {
